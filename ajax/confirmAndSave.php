...
@session_start();
	...
	{
	$sqlKiadas="insert into kltsg_submissions_kiadas_saved ( row_id, submissions_id, sub_id, user_id, institute_id,unit_id, brutto_osszes, netto_osszes, afa_osszes, mennyiseg, megnevezes, netto_egysegar, tax,category_tax_field, afa_ossz_egyseg, quant, brutto_egysegar,Year)
	...
	//echo $sql;
	$res=$GLOBALS['conn']->query($sql)or die("Hiba a kltsg_submissions_bevétel lekérdezésénél");

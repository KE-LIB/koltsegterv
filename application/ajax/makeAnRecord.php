...
@session_start();
$filename="analitikusRecord_".date('Y_m_d_his');
...
header('Pragma: public');
	...
	$sqlbev="SELECT 
		...
		FROM kltsg_submissions_bevetel_sent 
			 where unit_id=".$_GET['id']." and user_id=".$_GET['uid']." ORDER BY submissions_id DESC ";
...
$writer->setAuthor('ke');
foreach($rows as $row)
	$writer->writeSheetRow('Analitkus Egy Record', $row);

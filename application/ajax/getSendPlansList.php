...
<table class="table table-bordered"><thead>
	...
	echo '<tr><td>'.$i++.'</td><td colspan=""><select id="inst_unit_'.$i.'" class="form-control">';
		...
		WHERE kltsg_unit.id IN (SELECT unit_id FROM kltsg_policy WHERE user_id='".$_SESSION['id']."' );");
			...
			<a href="view/getViewPlan.php?id='.$record['submissions_id'].'" class="btn btn-warning" target="_blank" role="button"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp;Előnézet</a>

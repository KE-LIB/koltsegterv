...
<div class="options">
	...
	<button type="button" onclick='ajaxLoad("download")' class="btn btn-warning btn-lg opt-btn">
			...
			Miután be vittük az adatokat, magára a csv generálás gombra kattintva ahová lementettük ezt a fáljt és megnyitottuk, oda menti a csv fáljt is. <b>Nagyon fontos! a szabadon beírható részbe "Tervezett beszerzés/igénylés" kérek mindenkit, ne írjon ","-őt mert akkor elcsúsznek feltöltéskor a sorok!</b>Figyelem, ez még teszt állapotba van, tehát ezt csak a  legvégső esetbe használjuk!</li-->
			</ul></h4>
	</div>
	</div>
	<script>

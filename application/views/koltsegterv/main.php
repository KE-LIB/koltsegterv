...
<div class="options">
	...
	<button type="button" onclick=ajaxLoad("download") class="btn btn-warning btn-lg opt-btn">
			...
			<h4>Amennyiben nekiállnak felvinni a költségtervezőbe az adatokat,  kérem figylejenek rá hogy mindig!!! legyen legalább 1 kiadás benne, mert csak akkor mentődik el a tétel!</h4><h4>Fejlesztések:
<br><ul>
<li>Bekerült egy új fül a tervezőbe, a  <a data-toggle="tab" href="#feltolt" onclick="showFeltolt()" id="2">Feltöltés</a></li>
<li>Bekerült egy új gomb a bevétel és kiadás fülön <button type="submit"  value="1" name="upload_kiad_andFill" class="btn btn-warning" id="upload_kiad"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;Rovat rögzítése és újboli kitöltés</button> <br>Melynek segítségével ha ismétlődő tételt kívánnak felvinni, ez a gomb újra kitölti ugyanazokkal az adatokattal a felületet a hónap kivételével.</li><br>
